...
public class WebViewActivityCompanyNotFound extends Activity implements OnTouchListener, Handler.Callback {
	...
	public void onCreate(Bundle savedInstanceState) {
	   ...
	   try {
		   ...
		   InputStream stream = getAssets().open("not-identified.html");
